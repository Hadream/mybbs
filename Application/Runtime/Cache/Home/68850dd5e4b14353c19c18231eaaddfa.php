    ...
    <div id="header">
      ...
      <div  id="login">
        ...
        <form action="/index.php?m=home&c=login&a=dologin" method="post">
          ...
          <?php else:?>
          <br><br>
              <a href="http://www.mybbs.com/?m=admin&c=index&a=index">登录后台</a>
              当前用户  <a href="index.php?m=home&c=user&a=edit&uid=<?= $_SESSION['userInfo']['uid']?>"> <?=$_SESSION['userInfo']['uname'] ?></a>&nbsp&nbsp&nbsp&nbsp&nbsp
